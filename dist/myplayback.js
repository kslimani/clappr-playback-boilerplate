(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MyPlayback"] = factory(require("clappr"));
	else
		root["MyPlayback"] = factory(root["Clappr"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__94__) {
...
var _clappr = __webpack_require__(94);
...
var MyPlayback = /*#__PURE__*/function (_HTML5Video) {
  _inherits(MyPlayback, _HTML5Video);

  _createClass(MyPlayback, [{
    key: "name",
    get: function get() {
      return 'my_playback';
    }
    ...
    key: "canPlay",
    value: function canPlay(resource, mimeType) {
  ...
  function MyPlayback() {
    ...
    _classCallCheck(this, MyPlayback);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MyPlayback)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(MyPlayback, [{
    ...
    value: function play() {
      ...
      _get(_getPrototypeOf(MyPlayback.prototype), "play", this).call(this);
    }
  }, {
    key: "pause",
    value: function pause() {
      ...
      _get(_getPrototypeOf(MyPlayback.prototype), "pause", this).call(this);
...
var getOwnPropertyNamesExternal = __webpack_require__(68);
...
var fails = __webpack_require__(3);
var toObject = __webpack_require__(13);
var nativeGetPrototypeOf = __webpack_require__(22);
var CORRECT_PROTOTYPE_GETTER = __webpack_require__(56);
